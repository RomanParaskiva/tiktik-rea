        ...
        >
          ...
          <button onClick={handleSearch}
            className='absolute md:right-5 right-6 top-4 border-l-2
               border-gray-300 pl-4 text-2xl text-gray-200'>
            <BiSearch />
          </button>
        </form>
      </div>
      ...
      <div>
        {userProfile ? (
          <div className='flex gap-5 md:gap-10 '>
            <Link href='/upload'>
              <button className='flex items-center border-2 px-2 md:px-4 text-xl font-semibold gap-2 rounded-sm'>
              ...
              <Link href='/'>
                <>
                  <Image
                    ...
                    src={userProfile?.image || 'http://localhost:3000/vercel.svg'}
                    alt="profile phoot"
                  />
                </>
              </Link>
